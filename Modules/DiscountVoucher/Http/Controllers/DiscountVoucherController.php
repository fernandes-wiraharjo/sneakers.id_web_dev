    ...
    public function store(Request $request)
    {
        try {
            $validator = $request->validate([
                ...
                'apply_to' => 'required|in:shipping,product,cart',
                ...
                'apply_to.required' => 'Please choose where this voucher applies',
                'apply_to.in' => 'Apply to must be shipping, product, or entire cart',
                'min_purchase.required' => 'Minimum amount is required',
