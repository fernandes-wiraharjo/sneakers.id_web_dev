...
class ProductRepository extends Repository implements MasterRepositoryInterface {
    ...
    public function getProductWhere(){
        ...
        ->where(['is_active'=> 1])
        ->groupBy('products.id', 'products.product_code', 'products.product_name', 'products.product_link', 'products.shopee_link', 'products.blibli_link', 'products.description', 'products.image', 'products.visit', 'products.is_active', 'created_at','updated_at','pd.retail_price', 'pd.after_discount_price');
