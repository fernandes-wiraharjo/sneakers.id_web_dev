<x-base-layout>
    ...
    <x-slot name="title">
        <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Create Shipping Courier</h1>
    </x-slot>
    <!--begin::Card-->
    <div class="card">
        <!--begin::Card body-->
        <div class="card-body">
            <form action="{{ route('administrator.master-data.shipping-courier.store') }}" method="POST">
                @csrf
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <input type="text" name="code" class="form-control form-control-solid mb-3 mb-lg-0 @error('code') is-invalid @enderror"
                        placeholder="Enter courier code" value="{{ old('code') }}" required />
                    @error('code')
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0 @error('name') is-invalid @enderror"
                        placeholder="Enter courier name" value="{{ old('name') }}" required />
                    @error('name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
