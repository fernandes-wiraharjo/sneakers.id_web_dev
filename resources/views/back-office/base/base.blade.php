...
<head>
    ...
    @if (theme()->getViewMode() === 'preview')
        {{ theme()->getView('back-office.partials/trackers/_ga-general') }}
        {{ theme()->getView('back-office.partials/trackers/_ga-tag-manager-for-head') }}
    @endif
...
@stack('top-scripts')
@if (theme()->getViewMode() === 'preview')
    {{ theme()->getView('back-office.partials/trackers/_ga-tag-manager-for-body') }}
@endif
