...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 d-md-none px-0">
            <img src="{{ asset('stores-info/login-img.webp') }}" alt="Confirm Password" class="img-fluid">
        </div>
        ...
        <div class="d-none d-md-block col-6 pe-0 ps-5">
            <img src="{{ asset('stores-info/login-img-md.webp') }}" alt="Confirm Password" class="w-100">
        </div>
    </div>
</div>
@endsection
