            ...
            <div class="_1ip0g651 _1fragem1b _1fragemaf _1fragem1o _1fragem25">
                <div class="_1ip0g651 _1fragem1b _1fragemaf _1fragem1z _1fragem2g">
                    <section aria-label="Review" class="_1fragem15 _1fragemaf">
                        <div role="table" aria-label="Review your information" class="Z8Nx4 lT5DX">
                            ...
                            <div role="row" class="NSCO_">
                                <div class="Qk5zF">
                                    <div role="cell" class="w3cHO">
                                        <span class="_19gi7yt0 _19gi7yte _1fragem1j _19gi7yt7">Weight Total</span>
                                    </div>
                                    <div role="cell" class="nkp8r">
                                        <bdo dir="ltr" class="_19gi7yt0 _19gi7yte _1fragem1j">{{ number_format($shippingWeight / 1000, 2) }} Kg</bdo>
                                    </div>
                                </div>
                            </div>
                            @if($note != '')
                                <div role="row" class="NSCO_">
                                    <div class="Qk5zF">
                                        <div role="cell" class="w3cHO">
                                            <span class="_19gi7yt0 _19gi7yte _1fragem1j _19gi7yt7">Notes</span>
                                        </div>
                                        <div role="cell" class="nkp8r">
                                            <bdo dir="ltr" class="_19gi7yt0 _19gi7yte _1fragem1j">{{ $note }}</bdo>
                                        </div>
                                    </div>
                                </div>
                            @endif
                    ...
                    <main id="checkout-main">
                        <form action="" method="POST" novalidate="" id="Form12" class="_1fragem16">
                            <div class="_1fragemaf">
                                <div>
                                    <div class="VheJw">
                                        <div class="s_qAq">
                                            @if($shippingCourier != [])
                                                <section aria-label="Shipping method" class="_1fragem15 _1fragemaf">
                                                    <div class="_1ip0g651 _1fragem1b _1fragemaf _1fragem1o _1fragem25">
                                                        <div class="_1ip0g651 _1fragem1b _1fragemaf _1fragem1t _1fragem2a">
                                                            <h2 id="step-section-primary-header" tabindex="-1" class="n8k95w1 _1fragemaf n8k95w3">
                                                                Shipping method
                                                            </h2>
                                                        </div>
                                                        <div class="_1ip0g651 _1fragem1b _1fragemaf _1fragem1t _1fragem2a">
                            ...
                            <div class="_1fragem15 _1fragemah _1fragemaf">
                                <button type="submit" tabindex="-1" aria-hidden="true">Continue to payment</button>
                            </div>
                        </form>
                    </main>
                </div>
