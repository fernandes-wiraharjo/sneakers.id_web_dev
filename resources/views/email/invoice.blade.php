                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:20px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 140%;">Your order with id <strong>#{{ $order_id}}</strong> has been confirmed. Please proceed your payment before your order is expired. Thank you</p></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div align="right">
                                                                ...
                                                                <a href="{{ $invoice_url }}" target="_blank" class="v-button"
