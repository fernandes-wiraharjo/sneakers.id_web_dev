<div>
    <div class="d-flex flex-col m-2">
        <input type="text" class="form-control flex-lg-grow-1 rounded-start-0 rounded-end-0 bg-transparent " placeholder="SEARCH . . ." aria-label="keyword" aria-describedby="basic-addon1" wire:model="search" id="myInput"/>
