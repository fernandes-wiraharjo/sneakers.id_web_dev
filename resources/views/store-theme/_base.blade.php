...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- <meta name="description" content="@if(trim($__env->yieldContent('description'))) @yield('description') @else 'US PREORDER, READY STOCK, DAN CONSIGNMENT. HANYA MENJUAL BARANG ORIGINAL DAN AUTHENTIC. TIDAK MENJUAL BARANG PALSU.' @endif"> -->
         <meta name="description" content="@if(trim($__env->yieldContent('description'))) @yield('description') @else '' @endif">
        ...
        <meta property="og:description" content="@if(trim($__env->yieldContent('description'))) @yield('description') @else '' @endif">
        ...
        <meta property="twitter:description" content="@if(trim($__env->yieldContent('description'))) @yield('description') @else '' @endif">
