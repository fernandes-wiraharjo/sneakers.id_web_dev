                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <strong>{{ Carbon\Carbon::parse($log['timestamp'])->format('d/m/y H:i') }}</strong>
                                <br />
                                <small class="text-muted"><i class="far fa-clock"></i> {{
                                    Carbon\Carbon::parse($log['timestamp'])->diffForHumans() }}</small>
                                @endif
                            </td>
                            <td>{{ $log['env'] ?? '-' }}</td>
                            <td>
                                <span class="badge badge-{{ $log['color'] ?? 'warning' }}">{{ $log['type'] ?? '-'
                                    }}</span>
                            </td>
